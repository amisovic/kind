  ...
  template:
    ...
    spec:
      ...
      - command:
        ...
        env:
        - name: HTTP_PROXY
          value: http://10.49.98.4:8080
        - name: HTTPS_PROXY
          value: http://10.49.98.4:8080
        - name: NO_PROXY
          value: argocd-repo-server,argocd-application-controller,argocd-metrics,argocd-server,argocd-server-metrics,argocd-redis,argocd-dex-server,10.96.0.0/12,10.244.0.0/16,192.168.11.0/24,10.11.128.0/17,10.88.128.0/17
